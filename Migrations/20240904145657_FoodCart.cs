...
{
    /// <inheritdoc />
    public partial class FoodCart : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_MenuCategories_MenuCategoryCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingsAndReviews = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvailStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UsersUserID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryAgents", x => x.UserID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelieveryAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    TotalCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ItemID = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    MenuItemsItemID = table.Column<int>(type: "int", nullable: true),
                    UsersUserID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Menus_MenuItemsItemID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notification_Menus_MenuItemsItemID",
                        column: x => x.MenuItemsItemID,
                        principalTable: "Menus",
                        principalColumn: "ItemID");
                    table.ForeignKey(
                        name: "FK_Notification_Restaurants_RestaurantID",
                        column: x => x.RestaurantID,
                        principalTable: "Restaurants",
                        principalColumn: "RestaurantID");
                    table.ForeignKey(
                        name: "FK_Notification_Users_UsersUserID",
                        column: x => x.UsersUserID,
                        principalTable: "Users",
                        principalColumn: "UserID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Menus_MenuItemsItemID",
                        column: x => x.MenuItemsItemID,
                        principalTable: "Menus",
                        principalColumn: "ItemID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_MenuItemsItemID",
                table: "Carts",
                column: "MenuItemsItemID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_MenuCategoryCategoryID",
                table: "Menus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notification_MenuItemsItemID",
                table: "Notification",
                column: "MenuItemsItemID");

            migrationBuilder.CreateIndex(
                name: "IX_Notification_RestaurantID",
                table: "Notification",
                column: "RestaurantID");

            migrationBuilder.CreateIndex(
                name: "IX_Notification_UsersUserID",
                table: "Notification",
                column: "UsersUserID");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_MenuItemsItemID",
                table: "OrderItems",
                column: "MenuItemsItemID");
